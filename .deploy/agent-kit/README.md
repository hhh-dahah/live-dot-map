...
> 运行 curl -sL https://app.live-dot-map.workers.dev/agent-kit/setup.md 查看接入指引，按它在我的项目目录完成活点地图接入；如果拉取失败，把网址换成 https://test-d0gims26n5c5ce096-1425841737.tcloudbaseapp.com/agent-kit/setup.md 再试。
