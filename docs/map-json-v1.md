...
| `md` | string\|null | 详情 Markdown 相对路径，约定 `nodes/<num>-<名称>.md`。 |
...
| `md` | string\|null | 方案记录 Markdown，约定 `routes/<id>-<方案名>.md`。 |
...
```json
{
  ...
  "nodes": [
    { "id": "n1", "num": "01", "name": "开始", "type": "目的", "route": "r1", "x": 0, "y": 0, "md": "nodes/01-开始.md", "createdAt": "2026-08-01", "updatedAt": "2026-08-01" },
    { "id": "n2", "num": "02", "name": "生成图片", "type": "结果", "route": "r1", "x": 260, "y": 0, "md": "nodes/02-生成图片.md", "createdAt": "2026-08-01", "updatedAt": "2026-08-03" },
    { "id": "n3", "num": "03", "name": "完成放大", "type": "结果", "route": "r1", "x": 520, "y": 0, "md": "nodes/03-完成放大.md", "createdAt": "2026-08-02", "updatedAt": "2026-08-04" },
    { "id": "n4", "num": "04", "name": "动态壁纸完成", "type": "目的", "route": "r1", "x": 780, "y": 0, "md": "nodes/04-动态壁纸完成.md", "createdAt": "2026-08-01", "updatedAt": "2026-08-01" },
    { "id": "n5", "num": "05", "name": "幽灵脸问题", "type": "问题", "route": "r2", "x": 260, "y": 220, "md": "nodes/05-幽灵脸问题.md", "createdAt": "2026-08-03", "updatedAt": "2026-08-05" },
    { "id": "n6", "num": "06", "name": "幽灵脸问题解决", "type": "结果", "route": "r2", "x": 620, "y": 220, "md": "nodes/06-幽灵脸问题解决.md", "createdAt": "2026-08-05", "updatedAt": "2026-08-05" }
  ],
  "edges": [
