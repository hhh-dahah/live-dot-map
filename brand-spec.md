...
字级：面板正文 13px，画布标注 12–13px，首屏提问 28–32px，节点名称 13px，属性面板字段标签 11px 大写感（中文字重 500）。
...
4. 节点一律圆形，只显示编号 + 短名称；方案名称附着在线上；标注一句话，用黄色小便签包裹，归属由细引导线表明。
5. 状态颜色预算：一屏内除方案线外不出现红绿；紫蓝同屏至多两处（选中对象 + 激活工具）。

## 文案基调

短句、直接动作名：想探索什么？/ 选择项目 / 新建节点 / 地图已更新。
