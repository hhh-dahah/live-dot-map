...
const MAX_NAME = 80;
const MAX_ANN = 4000;
const MAX_AGENT_OBJECTS_PER_ENVELOPE = 50;
const MAX_AGENT_NEW_NODES_PER_ENVELOPE = 30;
const MAX_AGENT_MILESTONES_PER_ENVELOPE = 10;
const MAX_INITIAL_MAP_NODES = 50;
